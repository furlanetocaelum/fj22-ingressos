...
public class FilmeController {
    ...
    public ModelAndView detalhe(@PathVariable("id") Integer id) {
    	...
    	Optional<DetalhesDoFilme> detalhes = omdbClient.request(filme.getNome(), DetalhesDoFilme.class);
    	
    	modelAndView.addObject("sessoes", sessaoDao.buscarSessoesPorFilme(filme));
